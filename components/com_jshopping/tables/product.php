...
class jshopProduct extends JTableAvto{
    ...
    */    
    ...
    function getPrice($quantity=1, $enableCurrency=1, $enableUserDiscount=1, $enableParamsTax=1, $cartProduct=array()){
        ...
        $this->product_price_calculate = $this->product_price;
    ...
    function getPriceRozn($quantity=1, $enableCurrency=1, $enableUserDiscount=1, $enableParamsTax=1, $cartProduct=array()){
        $dispatcher = JDispatcher::getInstance();
        $jshopConfig = JSFactory::getConfig();

        $this->product_price_wp = $this->product_old_price;
        $this->product_price_calculate = $this->product_old_price;
