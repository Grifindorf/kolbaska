<div id = "jshop_module_cart" class="btn-cart-md">
    <a class="cart-link" href = "javascript:void(null)">
        <!-- Image -->
    ...
    <ul class="cart-dropdown" role="menu">
        <li class="delete"><div class="cart-item modulecart">В вашей корзине <div class="countpproducts"><?=$cart->count_product?></div> товаров</div></li>
        <?php
        $countprod = 0;
