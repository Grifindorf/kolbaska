...
<div class="single-item">
    ...
    <div class="container">
        ...
        <div class="single-item-content <?=($product->in_cart==1 ? 'inCart' : '')?>" id="product-<?=$this->product->product_id?>" itemscope itemtype="http://schema.org/Product">
            <div class="row">
                <div class="col-md-4 col-sm-5">
                    <!-- Product image -->
                    <?php foreach($this->images as $k=>$image){?>
                        <a href="<?php print $this->image_product_path?>/<?php print $image->image_name;?>" data-lightbox="group:fullproduct"><img itemprop="image" class="img-responsive img-thumbnail" id = "main_image_<?php print $image->image_id?>" src="<?php print $this->image_product_path?>/<?php print $image->image_name;?>" alt="<?php echo str_replace('"','\'',$this->product->name)?> - оптовый интернет-магазин kolbaska.com.ua" title="<?php echo str_replace('"','\'',$this->product->name)?> - оптовый интернет-магазин kolbaska.com.ua" /></a>
                    <?php }?>
                </div>
