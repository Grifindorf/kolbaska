            ...
            foreach ($results as $res) {
                if($res->typeeffect == 1) { ?>
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
                        <img src="/templates/kolbaska/img/slider/transparent.png" style="background-color:<?=$res->backgroundcolor?>" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption lfr large_bold_grey heading white"
                             ...
                             data-endspeed="300"
                             data-endeasing="Linear.easeNone"
                             data-captionhidden="off"><?=$res->home_banner_name?>
                        </div>
                        <!-- LAYER NR. 3 -->
                            ...
                            <?php
                                if($res->id == 1){
                                    ...
                                    <div class="playvideobutton">
                                        <a data-lightbox="width:800px; height:480px;" href="/Kolbaska_ru.mp4">
