...
# Date modified: 27/05/2014 - 13:00
# ------------------------------------------------------------------------
*/
...
class modK2OwlCarouselContentHelper
{
					...
					foreach ($item->extra_fields as $key => $extraField)
					{
						if ($extraField->type == 'textarea' || $extraField->type == 'textfield')
						{
							...
							if ($params->get('JPlugins', 1))
							{
								if (K2_JVERSION != '15')
								{
									$dispatcher->trigger('onContentPrepare', array('mod_ext_owl_carousel_k2_content', &$tmp, &$params, $limitstart));
								}
								else
								{
