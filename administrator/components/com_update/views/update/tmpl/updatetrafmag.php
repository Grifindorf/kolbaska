...
unlink('/home/www/dexline.com.ua/trafmag.xml');

$yaxml = fopen("/home/www/dexline.com.ua/trafmag.xml", "w");
...
mail('v.repij@gmail.com','Обновление trafmag',count($products));
mail('price@dexline.com.ua','Обновление trafmag',count($products));