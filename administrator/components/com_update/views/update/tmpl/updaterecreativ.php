...
unlink('/home/www/dexline.com.ua/recreativ.xml');

$yaxml = fopen("/home/www/dexline.com.ua/recreativ.xml", "w");
...
foreach ($results as $res) {
    $txt = "<offer id='".$res->product_id."' available='".($res->manufacturer_name=='DEX' ? 'true' : 'false')."'>\r\n";
    $txt .= "<url>http://dexline.com.ua/product/".$res->{'alias_ru-RU'}."</url>\r\n";
    $txt .= "<oldprice></oldprice>\r\n";
    $txt .= "<skidka></skidka>\r\n";
...
mail('v.repij@gmail.com','Обновление recreativ',count($products));
mail('price@dexline.com.ua','Обновление recreativ',count($products));