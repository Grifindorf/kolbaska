                    ...
                    <?php foreach ($result as $res) {
                        ...
                        <div class="category" id="category<?php echo $res->category_id; ?>">
                            ...
                            <div class="bonusproduct span7">
                                Изменение цены %:<br/><input name="jform[mainproductprice][<?php echo $res->category_id; ?>]" value="<?php echo $res->main_product_price; ?>" type="text"/>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
                            ...
                            <div class="brendcategory span12">
                                ...
                                <?php foreach (json_decode($res->category_id) as $rescategory) {
                                    ...
                                    <div class="category" id="category<?php echo $rescategory; ?>">
                                        ...
                                        <div class="bonusproduct span7">
                                            Изменение цены %:<br/><input name="jform[mainproductprice][<?php echo $rescategory; ?>]" value="<?php echo json_decode($res->main_product_price)->$rescategory; ?>" type="text"/>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
                    ...
                    <?php foreach ($result as $res) {
                        ...
                        <div class="product" id="product<?php echo $res->product_id; ?>">
                            <div class="mainproduct span5">
                                ...
                                <div id="productsort" style="clear: both">Сортировка: <input type="text" name="jform[productsort][sort][<?php echo $res->product_id; ?>]" value="<?php echo $res->mainordering; ?>"></div>
                            </div>
                            <div class="bonusproduct span7">
                                Изменение цены %:<br/><input name="jform[mainproductprice][<?php echo $res->product_id; ?>]" value="<?php echo $res->main_product_price; ?>" type="text"/>
                            </div>
                        </div>
                    <?php } ?>
                <?php } ?>
                ...
                jQuery.ajax({
                    ...
                    complete: function(response){
                        ...
                        jQuery(response.responseJSON['data'][0]).each(function(){
                            ...
                            '<div class="bonusproduct" style="display:none;">Изменение цены %:<br/><input name="jform[mainproductprice]['+this.id+']" type="text"/></div>'+
                            '</div>');
                        });
