...
class JshoppingModelProviders extends JModelLegacy{
    ...
    function getAllManufacturers($publish=0, $order=null, $orderDir=null){
        ...
        $query = "SELECT manufacturer_id, manufacturer_url, manufacturer_logo, manufacturer_publish, ordering, `".$lang->get('name')."` as name FROM `#__jshopping_providers` $query_where ".$queryorder;
