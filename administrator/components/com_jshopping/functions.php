...
function addSubmenu($vName){
    ...
    $menu['products'] = array(_JSHOP_MENU_PRODUCTS, 'index.php?option=com_jshopping&controller=products&category_id=0', $vName == 'products', $installaccess);
    $menu['orders'] = array( _JSHOP_MENU_ORDERS, 'index.php?option=com_jshopping&controller=orders', $vName == 'orders', $installaccess);
    $menu['users'] = array(_JSHOP_MENU_CLIENTS, 'index.php?option=com_jshopping&controller=users', $vName == 'users', $installaccess);
    $menu['other'] = array(_JSHOP_MENU_OTHER, 'index.php?option=com_jshopping&controller=other', $vName == 'other', $installaccess);
    ...
    $menu['info'] = array(_JSHOP_MENU_INFO, 'index.php?option=com_jshopping&controller=info', $vName == 'info', $installaccess);
...
function displayMainPanelIco(){
    ...
    $menu['products'] = array(_JSHOP_MENU_PRODUCTS, 'index.php?option=com_jshopping&controller=products&category_id=0', 'jshop_products_b.png', $installaccess);
    $menu['orders'] = array( _JSHOP_MENU_ORDERS, 'index.php?option=com_jshopping&controller=orders', 'jshop_orders_b.png', $installaccess);
    $menu['users'] = array(_JSHOP_MENU_CLIENTS, 'index.php?option=com_jshopping&controller=users', 'jshop_users_b.png', $installaccess);
    $menu['other'] = array(_JSHOP_MENU_OTHER, 'index.php?option=com_jshopping&controller=other', 'jshop_options_b.png', $installaccess);
    ...
    $menu['info'] = array(_JSHOP_MENU_INFO, 'index.php?option=com_jshopping&controller=info', 'jshop_info_b.png', $installaccess);
...
function displayOptionPanelIco(){
    ...
    $menu['providers'] = array(_JSHOP_MENU_PROVIDERS, 'index.php?option=com_jshopping&controller=providers', 'jshop_manufacturer_b.png', 1);
