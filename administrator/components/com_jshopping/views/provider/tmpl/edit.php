...
<div class="jshop_edit">
    <form action="index.php?option=com_jshopping&controller=providers" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
                ...
                <div class="col100">
                    <table class="admintable" >
                                ...
                                <select name="currency">
                                    <?php
                                        ...
                                        foreach($results as $result){
                                            ?>
                                                <option <?=($result->id == $row->currency ? 'selected="selected"' : '')?> value="<?=$result->id?>"><?=$result->name?></option>
                                            <?php
                                        }
                                    ?>
                                </select>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="inputbox" id="opt_percent" size="40" name="opt_percent" value="<?php echo $row->opt_percent;?>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="key">
                            ...
                            <td>
                                <input type="text" class="inputbox" id="rozn_percent" size="40" name="rozn_percent" value="<?php echo $row->rozn_percent;?>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="key">
                            ...
                            <td>
                                <input type="text" class="inputbox" id="provider_name"  name="provider_name" value="<?php echo $row->provider_name;?>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="key">
                            ...
                            <td>
                                <input type="text" class="inputbox" id="provider_phone"  name="provider_phone" value="<?php echo $row->provider_phone;?>" />
                            </td>
                        </tr>
                        <tr>
                            <td class="key">
