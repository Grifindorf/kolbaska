...
<form action="index.php?option=com_jshopping&controller=providers" method="post" name="adminForm" id="adminForm">
...
<?php foreach($rows as $row){?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
     <a href="index.php?option=com_jshopping&controller=providers&task=edit&man_id=<?php echo $row->manufacturer_id; ?>"><?php echo $row->name;?></a>
   </td>
   ...
   <td class="center">
        <a class="btn btn-micro" href='index.php?option=com_jshopping&controller=providers&task=edit&man_id=<?php print $row->manufacturer_id?>'>
            <i class="icon-edit"></i>
        </a>
   </td>
   <td class="center">
