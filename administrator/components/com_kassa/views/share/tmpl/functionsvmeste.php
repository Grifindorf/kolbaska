                            ...
                            <div class="bonusproduct span7">Добавить бонусный товар:<br><input type="text" block="category" data="<?php echo $res->category_id; ?>" id="searchbonusproduct">
                                <?php foreach ( json_decode($res->bonusproducts) as $bonid=>$bonprod ) {
                                    ...
                                    <div class="product" id="product<?php echo $bonid; ?>">
                                        ...
                                        <div id="bonusproductprice">Изменение цены %: <input type="text" name="jform[selectedbonusproductprice][<?php echo $res->category_id; ?>][<?php echo $bonid; ?>][]" value="<?php echo $bonprod[0]; ?>"></div>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                                        ...
                                        <div class="bonusproduct span7">
                                            ...
                                            <?php foreach ( json_decode($res->bonusproducts)->$rescategory as $bonid=>$bonprod ) {
                                                ...
                                                <div class="product" id="product<?php echo $bonid; ?>">
                                                    ...
                                                    <a onclick="delproduct(<?php echo $bonid; ?>)" class="actiontodo">удалить</a>
                                                    <div id="bonusproductprice">Изменение цены %: <input type="text" name="jform[selectedbonusproductprice][<?php echo $rescategory; ?>][<?php echo $bonid; ?>][]" value="<?php echo $bonprod[0]; ?>"></div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                            ...
                            <div class="bonusproduct span7">Добавить бонусный товар:<br><input type="text" block="product" data="<?php echo $res->product_id; ?>" id="searchbonusproduct">
                                <?php foreach ( json_decode($res->bonusproducts) as $bonid=>$bonprod ) {
                                    ...
                                    <div class="product" id="product<?php echo $bonid; ?>">
                                        ...
                                        <a onclick="delproduct(<?php echo $bonid; ?>)" class="actiontodo">удалить</a>
                                        <div id="bonusproductprice">Изменение цены %: <input type="text" name="jform[selectedbonusproductprice][<?php echo $res->product_id; ?>][<?php echo $bonid; ?>][]" value="<?php echo $bonprod[0]; ?>"></div>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
...
<script>
    function addbonusproduct(id,blockid,block) {
        ...
        jQuery('#product'+id).append('<div id="bonusproductprice">Изменение цены %: <input type="text" name="jform[selectedbonusproductprice]['+blockid+']['+id+'][]" /></div>');
